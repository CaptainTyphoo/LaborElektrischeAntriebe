...
\fancyhead[R]{v1.1\\www.fet.at} %Kopfzeile rechts
...
R_A&=\frac{U_{A,N}I_{A,N}-P_N}{I_{A,N}^2}=\frac{\SI{220}{\volt}\cdot\SI{5.348}{\ampere}\cdot\SI{1}{\kilo\watt}}{\mybr{\SI{5.348}{\ampere}}^2}=\SI{6.173}{\ohm}\\
U_{A,N}&=k_1\phi n_0\\
...
&=\frac{\frac{3}{\pi}\sqrt{2}\frac{\SI{300}{\volt}}{\num{2.2}}-\SI{6.173}{\ohm}\frac{2\pi\num{0.6}\cdot\SI{2.809}{\newton\metre}}{\SI{3.300}{\volt\second}}}{\SI{3.300}{\volt\second}}\SI{60}{\second\per\minute}=\SI{2899}{\rounds\per\minute}
\end{align}
...
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=500,
		xmax=3000]
	\addplot[domain=-3000:-2146.222, blue] {-1.2*400};
	\addplot[domain=-2146.222:1831.679, blue] {0.2433*156+14.48/60*x};
...
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=400,
		xmax=3000]
	\addplot[domain=-3000:3000, blue] {359.5};
    \end{axis}
\end{tikzpicture}
\end{figure*}
...
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=150000,
		xmax=3000]
	\addplot[domain=-3000:3000, blue] {359.5*2*pi*x/60};
    \end{axis}
\end{tikzpicture}
\end{figure*}
...
\begin{align}
U_{di\alpha}&=U_{di0}\cos\mybr{\alpha}\\
\alpha&=\arccos\mybr{\frac{U_{di\alpha}}{U_{di0}}}=\arccos\mybr{\frac{U_A\mybr{n}}{\frac{3}{\pi}\sqrt{2}U_{v,eff}}}=\arccos\mybr{\frac{U_A\mybr{n}}{\frac{3}{\pi}\sqrt{2}\cdot\SI{400}{\volt}}}=\SI{42.23}{\degree}
\end{align}
\begin{figure*}[!ht]
\centering
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=180,
		xmax=3000]
	\addplot[domain=-3000:-2146.222, blue] {acos(-1.2*400/(3/pi*sqrt(2)*400)};
	\addplot[domain=-2146.222:1831.679, blue] {acos((0.2433*156+14.48/60*x)/(3/pi*sqrt(2)*400)};
...
n_{Feldschw\ddot{a}ch,2}&=\frac{U_{A,max}-R_A I_{A,N}}{k_1\phi}=\frac{\num{1.2}\cdot\mybr{\SI{-400}{\volt}}-\SI{0.2433}{\ohm}\cdot\SI{156}{\ampere}}{\SI{14.48}{\volt\second}}\SI{60}{\second\per\minute}\\
&=\SI{-2146}{\rounds\per\minute}
\end{align}
Außerhalb des Intervalls $\mybr{\SI{-2146}{\rounds\per\minute},\SI{1832}{\rounds\per\minute}}$ ist ein Feldschwächbetrieb erforderlich.
