...
\fancyhead[R]{v1.2\\www.fet.at} %Kopfzeile rechts
...
Für Rechtslauf gilt
\begin{equation}
U_A=R_A I_{A,N}+k_1\phi n=\SI{0.2433}{\ohm}\cdot\SI{156}{\ampere}+\SI{14.48}{\volt\second}\frac{n}{\SI{60}{\second\per\minute}},
\end{equation}
bei Linkslauf dreht sich das Vorzeichen von $I_A$ um
\begin{equation}
U_A=R_A I_{A,N}+k_1\phi n=\SI{0.2433}{\ohm}\cdot\mybr{\SI{-156}{\ampere}}+\SI{14.48}{\volt\second}\frac{n}{\SI{60}{\second\per\minute}}.
\end{equation}
...
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=500,
		xmax=3000]
	\addplot[domain=-3000:-1831.679, blue] {-1.2*400};
	\addplot[domain=-1831.679:0, blue] {-0.2433*156+14.48/60*x};
	\addplot[domain=0:1831.679, blue] {0.2433*156+14.48/60*x};
	\addplot[domain=1831.679:3000, blue] {1.2*400};
    \end{axis}
\end{tikzpicture}
\end{figure*}
...
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=400,
		xmax=3000]
	\addplot[domain=-3000:-1831.679, blue] {(-1.2*400+0.2422*156)/(2*pi*x/60)*(-156)};
	\addplot[domain=-1831.679:0, blue] {-359.5};
	\addplot[domain=0:1831.679, blue] {359.5};
	\addplot[domain=1831.679:3000, blue] {(1.2*400-0.2422*156)/(2*pi*x/60)*156};
    \end{axis}
\end{tikzpicture}
\end{figure*}
...
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=80000,
		xmax=3000]
	\addplot[domain=-3000:-1831.679, blue] {68990};
	\addplot[domain=-1831.679:0, blue] {-359.5*2*pi*x/60};
	\addplot[domain=0:1831.679, blue] {359.5*2*pi*x/60};
	\addplot[domain=1831.679:3000, blue] {68990};
    \end{axis}
\end{tikzpicture}
\end{figure*}
...
\begin{align}
\alpha_1&=\arccos\mybr{\frac{R_A I_{A,N}+k_1\phi n}{\frac{3}{\pi}\sqrt{2}U_{v,eff}}}=\arccos\mybr{\frac{\SI{0.2433}{\ohm}\cdot\SI{156}{\ampere}+\SI{14.48}{\volt\second}\frac{n}{\SI{60}{\second\per\minute}}}{\frac{3}{\pi}\sqrt{2}\cdot\SI{400}{\volt}}}\\
\alpha_2&=\SI{90}{\degree},
\end{align}
bei Linkslauf ist die rechte Brücke aktiv
\begin{align}
\alpha_1&=\SI{90}{\degree}\\
\alpha_2&=\arccos\mybr{\frac{R_A I_{A,N}+k_1\phi n}{\frac{3}{\pi}\sqrt{2}U_{v,eff}}}=\arccos\mybr{\frac{\SI{0.2433}{\ohm}\cdot\mybr{\SI{-156}{\ampere}}+\SI{14.48}{\volt\second}\frac{n}{\SI{60}{\second\per\minute}}}{\frac{3}{\pi}\sqrt{2}\cdot\mybr{\SI{-400}{\volt}}}}.
\end{align}
\begin{figure*}[!ht]
\centering
\begin{tikzpicture}
	...
	\addplot[domain=-3000:-1831.679, red] {acos(-1.2*400/(3/pi*sqrt(2)*(-400))};
	\addlegendentry{$\alpha_2$}
	
	\addplot[domain=0:1831.679, blue] {acos((0.2433*156+14.48/60*x)/(3/pi*sqrt(2)*400)};
	\addplot[domain=1831.679:3000, blue] {acos(1.2*400/(3/pi*sqrt(2)*400)};
	\addplot[domain=-1831.679:0, red] {acos((-0.2433*156+14.48/60*x)/(3/pi*sqrt(2)*(-400))};
