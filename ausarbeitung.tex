...
\fancyhead[R]{v1.5\\www.fet.at} %Kopfzeile rechts
...
Für Rechtslauf gilt
\begin{equation}
U_A=R_A I_{A,N}+k_1\phi n=\SI{0.2433}{\ohm}\cdot\SI{156}{\ampere}+\SI{14.10}{\volt\second}\frac{n}{\SI{60}{\second\per\minute}},
\end{equation}
bei Linkslauf dreht sich das Vorzeichen von $I_A$ um
\begin{equation}
U_A=R_A I_{A,N}+k_1\phi n=\SI{0.2433}{\ohm}\cdot\mybr{\SI{-156}{\ampere}}+\SI{14.10}{\volt\second}\frac{n}{\SI{60}{\second\per\minute}}.
\end{equation}
...
\begin{align}
n_{Feldschw\ddot{a}ch,1}&=\frac{U_{A,max}-R_A I_{A,N}}{k_1\phi}=\frac{\num{1.2}\cdot\SI{400}{\volt}-\SI{0.2433}{\ohm}\cdot\SI{156}{\ampere}}{\SI{14.10}{\volt\second}}\SI{60}{\second\per\minute}\\
&=\SI{1881}{\rounds\per\minute}\\
n_{Feldschw\ddot{a}ch,2}&=\frac{-U_{A,max}-R_A I_{A,N}}{k_1\phi}=\frac{\num{1.2}\cdot\mybr{\SI{-400}{\volt}}-\SI{0.2433}{\ohm}\cdot\mybr{\SI{-156}{\ampere}}}{\SI{14.10}{\volt\second}}\SI{60}{\second\per\minute}\\
&=\SI{-1881}{\rounds\per\minute}.
\end{align}
\begin{figure*}[!h]
\centering
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=500,
		xmax=3000]
	\addplot[domain=-3000:-1881.043, blue] {-1.2*400};
	\addplot[domain=-1881.043:0, blue] {-0.2433*156+14.10/60*x};
	\addplot[domain=0:1881.043, blue] {0.2433*156+14.10/60*x};
	\addplot[domain=1881.043:3000, blue] {1.2*400};
    \end{axis}
\end{tikzpicture}
\end{figure*}
...
&=\SI{350.1}{\newton\metre}\frac{\SI{1881}{\rounds\per\minute}}{n}.
\end{align}
Bei Linkslauf dreht sich das Vorzeichen von $I_A$ um
\begin{align}
...
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=400,
		xmax=3000]
	\addplot[domain=-3000:-1881.043, blue] {350.1*1881/x};
	\addplot[domain=-1881.043:0, blue] {-350.1};
	\addplot[domain=0:1881.043, blue] {350.1};
	\addplot[domain=1881.043:3000, blue] {350.1*1881/x};
    \end{axis}
\end{tikzpicture}
\end{figure*}
...
&=\SI{350.1}{\newton\metre}\frac{\SI{1881}{\rounds\per\minute}}{\SI{60}{\second\per\minute}}2\pi=\SI{68.96}{\kilo\watt}
\end{align}
\begin{figure*}[!ht]
\centering
\begin{tikzpicture}
	\begin{axis}[
		...
		ymax=80000,
		xmax=3000]
	\addplot[domain=-3000:-1881.043, blue] {68960};
	\addplot[domain=-1881.043:0, blue] {-350.1*2*pi*x/60};
	\addplot[domain=0:1881.043, blue] {350.1*2*pi*x/60};
	\addplot[domain=1881.043:3000, blue] {68960};
    \end{axis}
\end{tikzpicture}
\end{figure*}
...
\end{align}
Bei Rechtslauf ist die linke Brücke aktiv
\begin{align}
\alpha_1&=\arccos\mybr{\frac{R_A I_{A,N}+k_1\phi n}{\frac{3}{\pi}\sqrt{2}U_{v,eff}}}=\arccos\mybr{\frac{\SI{0.2433}{\ohm}\cdot\SI{156}{\ampere}+\SI{14.10}{\volt\second}\frac{n}{\SI{60}{\second\per\minute}}}{\frac{3}{\pi}\sqrt{2}\cdot\SI{400}{\volt}}}\\
\alpha_2&=\SI{90}{\degree},
\end{align}
bei Linkslauf ist die rechte Brücke aktiv
\begin{align}
\alpha_1&=\SI{90}{\degree}\\
\alpha_2&=\arccos\mybr{\frac{R_A I_{A,N}+k_1\phi n}{\frac{3}{\pi}\sqrt{2}U_{v,eff}}}=\arccos\mybr{\frac{\SI{0.2433}{\ohm}\cdot\mybr{\SI{-156}{\ampere}}+\SI{14.10}{\volt\second}\frac{n}{\SI{60}{\second\per\minute}}}{\frac{3}{\pi}\sqrt{2}\cdot\mybr{\SI{-400}{\volt}}}}.
\end{align}
\begin{figure*}[!ht]
\centering
\begin{tikzpicture}
	\begin{axis}[
		...
		name=alphaplot]
	\addplot[domain=-3000:0, blue] {90};
	\addlegendentry{$\alpha_1$}
	\addplot[domain=-3000:-1881.043, red] {acos(-1.2*400/(3/pi*sqrt(2)*(-400))};
	\addlegendentry{$\alpha_2$}
	
	\addplot[domain=0:1881.043, blue] {acos((0.2433*156+14.10/60*x)/(3/pi*sqrt(2)*400)};
	\addplot[domain=1881.043:3000, blue] {acos(1.2*400/(3/pi*sqrt(2)*400)};
	\addplot[domain=-1881.043:0, red] {acos((-0.2433*156+14.10/60*x)/(3/pi*sqrt(2)*(-400))};
	\addplot[domain=0:3000, red] {90};
...
\subsection{}
Außerhalb des Intervalls $\mybr{\SI{-1881}{\rounds\per\minute},\SI{1881}{\rounds\per\minute}}$ ist ein Feldschwächbetrieb erforderlich.
...
\section{}
\begin{align}
U_Netz&=U_0+R_i I_A = \SI{180}{\volt} + \SI{4}{\ohm}I_A\\
...
&=\frac{2}{3\cdot\SI{14.14}{\ampere}}\mybr{\SI{-14.95}{\ampere}+\SI{9.09}{\ampere}\e^{\j\SI{120}{\degree}}+\SI{4.84}{\ampere}\e^{\j\SI{240}{\degree}}}\\
&=\num{-0.9861}+\j\num{0.1735}\\
